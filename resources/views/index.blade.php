...
<section id="gtco-welcome" class="bg-white section-padding">
    <div class="container">
        <div class="section-content">
            <div class="row">
                <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style="background-image: url('{{ asset('assets/img/hero-2.jpg') }}');">
        ...
        <div class="section-content">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src=src="{{asset('assets/img/steak.jpg')}}" alt="" class="img-fluid shadow w-100">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="{{asset('assets/img/salmon-zucchini.jpg')}}"  alt="" class="img-fluid shadow w-100">
                </div>
...
<section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image:url('{{ asset('assets/img/reservation-bg.jpg') }}');">
    <div class="container">
        <div class="section-content">
            <div class="heading-section text-center">
                <span class="subheading">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('assets/img/chef-1.jpg')}}"alt="">
                        <div class="team-desc">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('assets/img/chef-2.jpg')}}"alt="">
                        <div class="team-desc">
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="{{asset('assets/img/chef-3.jpg')}}"alt="">
                        <div class="team-desc">
